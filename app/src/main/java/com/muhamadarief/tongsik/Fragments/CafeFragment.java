...
public class CafeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<Tongkrongan> cafe = new ArrayList<>();

        cafe.add(new Tongkrongan(R.mipmap.ic_launcher,"Rumah Makan Serba Sari","Ini Alamatnya", "Ini Harganya"));
        cafe.add(new Tongkrongan(R.mipmap.ic_launcher,"Rumah Makan Khas Sunda","Ini Alamatnya", "Ini Harganya"));
        cafe.add(new Tongkrongan(R.mipmap.ic_launcher,"Rumah Makan Serba Sari","Ini Alamatnya", "Ini Harganya"));
        ...
        TongkronganAdapter adapter = new TongkronganAdapter(getActivity(), cafe);
